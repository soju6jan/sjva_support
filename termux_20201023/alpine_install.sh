...
apk add --no-cache python3 py3-pip python3-dev py3-lxml py3-sqlalchemy py3-gevent py3-gevent-websocket py3-pycryptodome py3-markupsafe py3-yarl py3-aiohttp py3-wheel py3-markdown py3-psutil
